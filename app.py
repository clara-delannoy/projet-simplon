...
#groupby('produit') : regroupe les données par produit
...
#px.bar() : crée un graphique à barres avec les données de chiffre_affaires_par_produit, en utilisant 'produit' pour l'axe x et 'ca' pour l'axe y, et en définissant le titre du graphique
figure.write_html('chiffre-affaires-par-produit.html')
#write_html() : enregistre le graphique dans un fichier HTML nommé 'chiffre-affaires-par-produit.html'
